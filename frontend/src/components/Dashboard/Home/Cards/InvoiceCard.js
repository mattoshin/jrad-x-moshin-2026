...
export const InvoiceCard = (props) => {
  ...
  return (
    <div
      className="row mb-1 invoice-sub" onClick={() => nav(`/invoice/${props.stripe_tid}`)}
    >
    <div
      className="col-3 col-lg-3 d-flex align-items-center "
    ...
    >
      ...
      <div className="col-3" style={{ overflowX: "overlay" }}>
        <div
