    ...
    <Fragment>
      <div style={{ padding: "55px" }}>
        <h2 className="text-white mb-4">
          Privacy Policy of MOCEAN TECHNOLOGIES, INC
        </h2>
        <p className="text-white">
          MOCEAN TECHNOLOGIES, INC. operates the mocean.info website, which
          provides the SERVICE.
        </p>
        <p className="text-white text-left">
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the mocean website.
        </p>
        <p className="text-white text-left">
        ...
        <p className="text-white text-left">
          ...
          Terms and Conditions, which is accessible at mocean.info, unless
          otherwise defined in this Privacy Policy.
        </p>
        <h3 className="text-white mb-4">Information Collection and Use</h3>
        <p className="text-white text-left">
        ...
        <h3 className="text-white mb-4">Log Data</h3>
        <p className="text-white text-left">
        ...
        <h3 className="text-white mb-4">Cookies</h3>
        <p className="text-white text-left">
        ...
        <p className="text-white text-left">
          ...
          of our Service. For more general information on cookies, please read
        ...
        <h3 className="text-white mb-4">Service Providers</h3>
        <p className="text-white">
        ...
        <h3 className="text-white mb-4">Links to Other Sites</h3>
        <p className="text-white text-left">
        ...
        <h3 className="text-white mb-4">Changes to This Privacy Policy</h3>
        <p className="text-white">
