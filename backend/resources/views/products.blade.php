                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 100px">
                                                <a href="product/edit/{{$product->id}}" class="btn btn-outline-secondary btn-sm edit" title="Edit">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a href="product/delete/{{$product->id}}" class="btn btn-outline-secondary btn-sm edit" title="Delete">
