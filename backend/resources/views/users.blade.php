                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$users->getBusinessesWithProducts()}}</td>
                                            <td>{{$users->discord_id}}</td>
                                            <td><a href="https://dashboard.stripe.com/customers/{{$users->stripe_customer}}">{{$users->stripe_customer}}</a></td>
                                            <td>{{$users->customer_name}}</td>
                                            <td>{{$users->email}}</td>

                                            <td style="width: 100px">
                                                <a href="user/{{$users->id}}" class="btn btn-outline-secondary btn-sm edit" title="Edit">
